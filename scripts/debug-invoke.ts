...
process.env.STEALERS_TABLE_NAME ??= 'Stealers';
process.env.BLOCKED_VICTIMS_TABLE_NAME ??= 'BlockedVictims';
process.env.STEAL_PICKS_TABLE_NAME ??= 'StealPicks';
process.env.LINEUP_PICKS_TABLE_NAME ??= 'LineupPicks';
